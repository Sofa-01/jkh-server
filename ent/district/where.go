...
// HasJkhUnitsWith applies the HasEdge predicate on the "jkh_units" edge with a given conditions (other predicates).
func HasJkhUnitsWith(preds ...predicate.JkhUnit) predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := newJkhUnitsStep()
...
func HasBuildings() predicate.District {
	return predicate.District(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasBuildingsWith(preds ...predicate.Building) predicate.District {
	return predicate.District(func(s *sql.Selector) {
