...
func (_c *TaskCreate) SetBuildingID(v int) *TaskCreate {
	_c.mutation.SetBuildingID(v)
	return _c
}

// SetChecklistID sets the "checklist_id" field.
func (_c *TaskCreate) SetChecklistID(v int) *TaskCreate {
	_c.mutation.SetChecklistID(v)
	return _c
}

// SetInspectorID sets the "inspector_id" field.
func (_c *TaskCreate) SetInspectorID(v int) *TaskCreate {
...
func (_c *TaskCreate) SetActID(id int) *TaskCreate {
	_c.mutation.SetActID(id)
	return _c
}

// SetNillableActID sets the "act" edge to the InspectionAct entity by ID if the given value is not nil.
func (_c *TaskCreate) SetNillableActID(id *int) *TaskCreate {
	if id != nil {
		_c = _c.SetActID(*id)
	}
	return _c
...
func (_c *TaskCreate) SetAct(v *InspectionAct) *TaskCreate {
...
func (_c *TaskCreate) check() error {
	if _, ok := _c.mutation.BuildingID(); !ok {
		return &ValidationError{Name: "building_id", err: errors.New(`ent: missing required field "Task.building_id"`)}
	}
	if _, ok := _c.mutation.ChecklistID(); !ok {
		return &ValidationError{Name: "checklist_id", err: errors.New(`ent: missing required field "Task.checklist_id"`)}
	}
	if _, ok := _c.mutation.InspectorID(); !ok {
		return &ValidationError{Name: "inspector_id", err: errors.New(`ent: missing required field "Task.inspector_id"`)}
	}
	...
	if _, ok := _c.mutation.ScheduledDate(); !ok {
		return &ValidationError{Name: "scheduled_date", err: errors.New(`ent: missing required field "Task.scheduled_date"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
	...
	if len(_c.mutation.InspectorIDs()) == 0 {
		return &ValidationError{Name: "inspector", err: errors.New(`ent: missing required edge "Task.inspector"`)}
	}
	if len(_c.mutation.BuildingIDs()) == 0 {
		return &ValidationError{Name: "building", err: errors.New(`ent: missing required edge "Task.building"`)}
	}
	if len(_c.mutation.ChecklistIDs()) == 0 {
		return &ValidationError{Name: "checklist", err: errors.New(`ent: missing required edge "Task.checklist"`)}
	}
	return nil
}
